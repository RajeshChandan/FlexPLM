 ...
 * 
 */
@WebFault(name = "SQLException", targetNamespace = "http://www.sportmaster.ru/plmservice")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.sportmaster.wc.interfaces.webservices.bean.SQLException
     */
