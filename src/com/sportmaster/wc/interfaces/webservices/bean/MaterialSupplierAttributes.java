...
/**
 * <p>Java class for MaterialSupplierAttributes complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="MaterialSupplierAttributes">
 *   &lt;complexContent>
 ...
 *         &lt;element name="materialSize" type="{http://www.sportmaster.ru/plmservice}MaterialSize" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "MaterialSupplierAttributes", propOrder = {
    "smMDMVENDOR",
    "smSupplierName",
    "smLeadTimeGeneral",
    "nominated",
...
public class MaterialSupplierAttributes {
    ...
    protected List<MaterialSize> materialSize;
    ...
    /**
     * Gets the value of the materialSize property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the materialSize property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMaterialSize().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<MaterialSize> getMaterialSize() {
        if (materialSize == null) {
            materialSize = new ArrayList<MaterialSize>();
        }
