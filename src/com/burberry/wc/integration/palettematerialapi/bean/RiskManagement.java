...
public class RiskManagement implements Serializable
{
    ...
    @JsonPropertyDescription("Risk Level")
    ...
    /**
     * Return 'DELETE' in case material risk management row is deleted
     * 
     */
    @JsonProperty("CRUD")
    @JsonPropertyDescription("Return 'DELETE' in case material risk management row is deleted")
    private String cRUD;
    private final static long serialVersionUID = 5383565702894967170L;
