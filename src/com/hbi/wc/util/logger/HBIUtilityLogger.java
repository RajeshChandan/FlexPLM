 ...
 */
package com.hbi.wc.util.logger;
 ...
 *
 */
public class HBIUtilityLogger extends Logger {

	private static String strPath = "D:\\ptc\\Windchill_11.2\\Windchill\\logs\\";
     ...
     * @param name
     */
    protected HBIUtilityLogger(String name) {
        super(name);
    }

    public static Logger createInstance(Class classname, String logLevel, String strFileName) {
        if (utilLogger == null) {
        	utilLogger = HBIUtilityLogger.getLogger(classname, strPath + strFileName, logLevel);
        } else {
        	utilLogger = HBIUtilityLogger.getLogger(classname, null, logLevel);
        }
        return utilLogger;
    }
