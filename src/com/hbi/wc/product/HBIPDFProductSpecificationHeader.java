...
/*******************************************************************************************************************************
* HBIPDFProductSpecificationHeader.java
*
* This file used to generates the Header for a ProductSpecification Report
*
*/
public class HBIPDFProductSpecificationHeader extends PdfPTable implements PDFHeader{
       ...
       */
        public HBIPDFProductSpecificationHeader() {
        }

	    public HBIPDFProductSpecificationHeader(int cols) {
          super(cols);
        }
...
/**	  private PdfPCell createImageCellProductThumbnail(Map params) throws WTException{
	     ...
	     try{
            ...
            image.scaleToFit(30f, 400f);
			//image.scaleAbsolute(50f, 80f);
        ...
        */
		private PdfPCell createGPDataCell(Map params) throws WTException{
			  ...
			  try{
				...
				//HBI added for Pattern Version - Start - 2/10/2019
				...
				//HBI added for Pattern Version - End - 2/10/2019
	    ...
	    private PdfPCell createDataCell(Map params) throws WTException{
		  ...
		  try{
			...
			{  //
			 ...
			 //COmmented by UST - to display the value in Tech Pack 01/02/2013
			...
			PdfPTable headerTable = new PdfPTable(colWidths);
  			...
  			//float [] rowWidths = {6.0F,9.0F,6.0F,9.0F,4.0F,11.0F};
			//float [] rowWidths = {6.0F,9.0F,4.0F,11.0F,6.0F,9.0F};
			float [] rowWidths = {8.0F,30.0F,8.0F,14.0F,12.0F,18.0F}; 
			if(product.getFlexType().getFullName().indexOf(LABEL) > -1){
				rowWidths = new float[] {20.0F,35.0F,12.0F,25.0F};
			}
