...
@Path("/lowes")
public class NotificationSchemaWebServiceController extends AbstractRFARestService {

    private static final Logger logger = LogR.getLogger(NotificationSchemaWebServiceController.class.getName());
