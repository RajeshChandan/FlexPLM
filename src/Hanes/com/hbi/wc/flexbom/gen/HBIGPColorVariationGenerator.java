...
* @Date Apr 26, 2019, 12:58 PM
* 
*
*       This class is implemented by taking the code from HBIGPColorVariationGenerator and
*       modified as per requirement
* 
*/

public class HBIGPColorVariationGenerator extends BomDataGenerator {
...
/* Added for CA # 318-13 -- end*/
    ...
    public float itemDescWidth = (new Float(LCSProperties.get("com.lcs.wc.flexbom.gen.ColorGenerator.itemDescWidth", "3.0"))).floatValue();

    //public float partNameWidth = (new Float(LCSProperties.get("com.lcs.wc.flexbom.gen.HBIGPColorVariationGenerator.partNameWidth", "1.5"))).floatValue();
    //public float materialNameWidth = (new Float(LCSProperties.get("com.lcs.wc.flexbom.gen.HBIGPColorVariationGenerator.materialNameWidth", "1.25"))).floatValue();
    public float supplierNameWidth = (new Float(LCSProperties.get("com.lcs.wc.flexbom.gen.HBIGPColorVariationGenerator.supplierNameWidth", "1.25"))).floatValue();
    //public float colorwayWidth = (new Float(LCSProperties.get("com.lcs.wc.flexbom.gen.HBIGPColorVariationGenerator.colorwayWidth", "0.75"))).floatValue();
	
	//Changed width of the columns in Tech Pack
    public float partNameWidth = (new Float(LCSProperties.get("com.lcs.wc.flexbom.gen.HBIGPColorVariationGenerator.partNameWidth", "1.25"))).floatValue();
    public float materialNameWidth = (new Float(LCSProperties.get("com.lcs.wc.flexbom.gen.HBIGPColorVariationGenerator.materialNameWidth", "1.0"))).floatValue();
    public float colorwayWidth = (new Float(LCSProperties.get("com.lcs.wc.flexbom.gen.HBIGPColorVariationGenerator.colorwayWidth", "1.0"))).floatValue();
    ...
    public int imageWidth = (new Integer(LCSProperties.get("com.lcs.wc.flexbom.gen.HBIGPColorVariationGenerator.matThumbWidth", "75"))).intValue();
    public int imageHeight = (new Integer(LCSProperties.get("com.lcs.wc.flexbom.gen.HBIGPColorVariationGenerator.matThumbHeight", "0"))).intValue();

    public boolean USE_DEFAULT_COLUMNS = LCSProperties.getBoolean("com.lcs.wc.flexbom.gen.HBIGPColorVariationGenerator.useDefaultColumns");
    public boolean DEBUG = LCSProperties.getBoolean("com.lcs.wc.flexbom.gen.HBIGPColorVariationGenerator.verbose");

    private static final String DISPLAY_VAL = "DISPLAY_VAL";
    @SuppressWarnings("rawtypes")
	private Map dimensionMap;

    /** Creates a new instance of HBIGPColorVariationGenerator */
    ...
    public HBIGPColorVariationGenerator() {
    }
	...
	public Collection getTableColumns() throws WTException {
        ...
        if(this.view != null){
			...
			if(viewAtts.contains("BOM.supplierDescription")){
				viewAtts.remove("BOM.supplierDescription");
			}
			/*-- END -- */
    ...
    */
	...
	private boolean isBOMGPGarmentSourced(FlexBOMPart part) {
		if ((part != null) && part.getFlexType().getFullName(true).equals(MATERIAL_HBI_GARMENT_SOURCED_BOM)) {
			return true;
		}
		return false;
	}
 ...
 */
	private boolean isBOMGPRoutingTable(FlexBOMPart part) {
		if (part != null && part.getFlexType().getFullName(true).equals(MATERIAL_HBI_ROUTING_BOM)) {
			return true;
		}
		return false;
	}   
  ...
  */
	...
	private void initDimensionMap(FlexObject TopLevel) throws WTException {
      ...
      if (this.getSources().size() == 0)
      {
         ...
         //String bomOid = "OR:wt.part.WTPartMaster:" + TopLevel.getString ("FLEXBOMLINK.IDA3A5");
