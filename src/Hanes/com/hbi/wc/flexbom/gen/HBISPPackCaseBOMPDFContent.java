...
* 
*/
public class HBISPPackCaseBOMPDFContent extends BOMPDFContentGenerator {
    ...
    public static final String  SP_BOM_TYPE_PATH = LCSProperties.get("bomreport.packcase.salesproduct.bomtypes");
	
    /** Creates a new instance of SizePDFContent */
    public HBISPPackCaseBOMPDFContent() {
    }
   	...
   	public Collection getPDFContentCollection(Map params, Document document) throws WTException {
		...
		HBISPPackCaseBOMGenerator bomDG = new HBISPPackCaseBOMGenerator();
		FlexBOMPart bomPart = (FlexBOMPart) params.get(BOMPDFContentGenerator.BOM_PART);
		
		boolean spBOMTechpackStatus = isValidateBOMTypeForSPPackCaseReport(bomPart);
    ...
    * @Date 12/14/2018 
    */
  public boolean isValidateBOMTypeForSPPackCaseReport(FlexBOMPart bomPart) throws WTException
   {
